            ...
            <div class="content">
                ...
                @if($order->order_status)
                    ...
                    @if(!$order->payment_status)
                        <form action="/admin/order/{{$order->id}}/paid" method="post">
                            {{ csrf_field() }}
                            <input type="submit" value="Mark as Paid" class="btn-full btn btn-primary">
                        </form>
                    @endif
                    <form action="/admin/order/{{$order->id}}/cancel" method="post">
                        {{ csrf_field() }}
                        <input type="submit" value="Cancel order" class="btn-full btn btn-danger required-confirm">
                    </form>
                @endif
            </div>
        </div>
